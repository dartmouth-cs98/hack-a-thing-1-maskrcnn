...
capture = cv2.VideoCapture('rwestbrook.gif')
print("cv2.CAP_PROP_FRAME_WIDTH: " + str(cv2.CAP_PROP_FRAME_WIDTH))
print("cv2.CAP_PROP_FRAME_HEIGHT: " + str(cv2.CAP_PROP_FRAME_HEIGHT))
size = (
